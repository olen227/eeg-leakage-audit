...
def make_fig_3_1() -> list:
    ...
    fig.suptitle(
        "Рисунок 11 – Каскад протоколов: деградация метрик при устранении утечки\n"
...
def make_fig_3_2() -> list:
    ...
    fig.suptitle(
        "Рисунок 12 – Вклады компонентов утечки в завышение F1-меры\n"
...
def make_fig_3_3() -> list:
    ...
    fig.suptitle(
        "Рисунок 8 – Сравнение схем оценки оператора идентификации\n"
...
def make_fig_3_4() -> list:
    ...
    fig.suptitle(
        "Рисунок 9 – Разброс качества оператора по фолдам "
...
def make_fig_3_5() -> list:
    ...
    fig.suptitle(
        f"[{SLICE_NOTE_OLD}]\n"
        "Рисунок 10 – Проверка скрытого дубля chb01/chb21 по расстояниям "
...
def make_fig_3_6() -> list:
    ...
    fig.suptitle(
        f"[{SLICE_NOTE_OLD}]\n"
        "Рисунок 14 – Вклад компонентов честного протокола: "
...
def make_fig_3_7() -> list:
    ...
    fig.suptitle(
        "Рисунок 13 – Матрицы ошибок по объединённым данным: "
...
def make_fig_3_8() -> list:
    ...
    fig.suptitle(
        f"[{SLICE_NOTE_OLD}]\n"
        "Рисунок 15 – Важность частотных полос четырьмя способами "
